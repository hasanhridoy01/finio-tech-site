...
import ProductCarousel6 from "@/components/products-components/ProductCarousel6";
    ...
    <div className="container mx-auto md:pt-44 pt-28 md:px-0 px-5 h-auto">
      <div className="my-10">
        ...
        <h3 className="md:text-[18px] text-[14px] font-medium text-[#222222] text-center md:text-start md:w-[850px] w-full">
          A robust identity verification solution designed for digital assets
          and blockchain transactions, ensuring secure and compliant user
          authentication.
        </h3>
      </div>
        ...
        <div className="my-7">
          <div className="mb-7">
            ...
            <p className="md:text-[16px] text-[14px] font-[500] text-[#555] text-center md:text-start mb-4 leading-[30px]">
              A robust identity verification solution designed for digital
              assets and blockchain transactions, ensuring secure and compliant
              user authentication.
            </p>
            <p className="md:text-[16px] text-[14px] font-[500] text-[#555] text-center md:text-start mb-2 leading-[30px]">
              At FinioTech, we offer an advanced e-KYC solution that simplifies
              customer verification using cutting-edge technology. Our system
              ensures secure, remote, and efficient identity verification,
              helping businesses stay compliant while delivering a faster and
