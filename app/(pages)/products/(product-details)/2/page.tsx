...
import ProductCarouselTwo from "@/components/products-components/ProductCarouselTwo";
        ...
        <div className="my-7">
          <div className="mb-7">
            ...
            <p className="md:text-[16px] text-[14px] font-[500] text-[#555] text-center md:text-start mb-4 leading-[30px]">
              E-Wallet Mobile App offering fast, secure, and seamless
              transactions for businesses and individuals, with global
              accessibility and convenience for on-the-go payments. Simplifying
              digital transactions for users anytime, anywhere.
            </p>
            <p className="md:text-[16px] text-[14px] font-[500] text-[#555] text-center md:text-start mb-2 leading-[30px]">
              We, at FinioTech, developed a secure and user-friendly E-Wallet
              Mobile App for our client, STPay. This app enables fast, seamless
              transactions for both businesses and individuals, offering
              enhanced security, global accessibility, and convenience for
              on-the-go payments. By partnering with STPay, we've created a
              solution that simplifies digital transactions, making it easier
              for their customers to manage payments anytime, anywhere.
            </p>
          </div>
