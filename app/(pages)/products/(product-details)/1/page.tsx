    ...
    <div className="container mx-auto md:pt-44 pt-28 md:px-0 px-5 h-auto">
      <div className="my-10">
        ...
        <h3 className="md:text-[18px] text-[14px] font-medium text-[#222222] text-center md:text-start md:w-[850px] w-full">
          ...
          transactions, customer onboarding, and innovative financial services.
        </h3>
      </div>
        ...
        <div className="my-7">
          <div className="mb-7">
            ...
            <p className="md:text-[16px] text-[14px] font-[500] text-[#555] text-center md:text-start mb-2 leading-[30px]">
              We, at FinioTech, offer Neo Banking solutions that revolutionize
              the way businesses and individuals manage finances. Our
              digital-first banking platform provides convenient, secure, and
              seamless banking experiences without the need for traditional
              brick-and-mortar branches. With features like online account
              management, instant payments, and advanced security, Neo Banking
              empowers customers with greater control and flexibility over their
