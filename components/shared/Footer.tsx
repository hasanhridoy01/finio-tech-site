  ...
  return (
    <div className="bg-[#D0E2DD] md:mt-[500px] mt-56">
      ...
      <div className="container mx-auto md:pt-20 pt-10 pb-3 px-5 relative">
        ...
        <div className="mt-96 mb-20 px-0 md:flex flex-col hidden gap-1">
          <h2 className="md:text-[32px] text-[20px] font-[700] text-[#555555] text-center">
            Hy!
            <strong className=" font-[400] ml-1">
              Make a shorter financial journey and grow the business faster.
            </strong>{" "}
          </h2>
          <h2 className="md:text-[46px] text-[20px] font-[700] text-[#555555] text-center">
        ...
        {/* Contact Section */}
        <hr className="my-5 border-1 border-[#AED0C7]" />
        <div className="grid md:grid-cols-12 grid-cols-2 gap-4 my-12">
          ...
          <div className="col-span-full md:col-span-4 flex justify-start md:justify-end ">
            <div className="max-w-[320px]">
              ...
              <div className="">
                ...
                <div className="flex gap-3 items-center mt-6">
                  <a
                    href="https://www.instagram.com/finiotech/"
                    target="_blank"
                  >
                    <svg
                      width="25"
        ...
        <hr className="my-5 border-t-[1px] border-[#8CBEB1]" />
